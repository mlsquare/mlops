...
[Andrej Karpathy](https://karpathy.ai/) is said to have coined the term [Software 2.0](https://karpathy.medium.com/software-2-0-a64152b37c35) to refer modern day ML. If any thing, Software 2.0 is a different beast compared to Software 1.0 (the classical software).
...
- Modern frameworks like [MetaFlow](https://metaflow.org/) address this key issue of idempotency.  But again, no single tool/library/framework may be sufficient as no one size fits all. The empahsis and priority depend on type of the problem and the type of the organization. It can lead to over-engineering and premature optimziation otherwise. Read [this](https://cloud.google.com/architecture/mlops-continuous-delivery-and-automation-pipelines-in-machine-learning) Google article on MLOps levels.
...
This incurs lot of _tech debt_. And a git template that integrates many tools with specific responsibilities is needed. Goal is to support as many quality attribute as possible by delegating them to tools as much as possible. We refer to such a stack as _ML Pod_. Such a git template for supporting image-based workflows is under development [here](https://github.com/mlsquare/image-ml-pod). Read the documentation [here](https://mlsquare.github.io/image-ml-pod/docs/).
